...
namespace Tamin.Controllers
{
    ...
    public class AdminContactsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ContactId,Name,Family,Tell,Email,Subject,TestContact")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ContactId,Name,Family,Tell,Email,Subject,TestContact")] Contact contact)
        {
            if (ModelState.IsValid)
            {
